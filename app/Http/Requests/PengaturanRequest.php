...
class PengaturanRequest extends FormRequest
{
    ...
    public function rules()
    {
         return [
            ...
            'banner' => 'nullable|file|max:5048|image|mimes:jpg,jpeg,png',
    ...
    public function messages()
    {
        return [
          ...
          'banner.max' => 'Ukuran logo maksimal 2MB',
          'banner.image' => 'Yang anda upload bukan gambar',
          'banner.mimes' => 'Ekstensi gambar harus JPEG, JPG, atau PNG',
